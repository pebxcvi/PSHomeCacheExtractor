...
|----------|-----------|----------|----------|----------|
| 1.02 | NPIA00005 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, POOL_BOWLING.BAR, DYNFILES.BAR, SPURIOUS.BAR, ARCADEPUZZLE.BAR, CHESS_DRAUGHTS.BAR, SCENE_CINEMA_AUDITORIUM.BAR, JAVA.BAR, OBJECTS_DEFAULT_AVATAR.BAR | | NPIA00005 01.02.pkg |
| 1.00 | NPIA00005 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, POOL_BOWLING.BAR, DYNFILES.BAR, SPURIOUS.BAR, ARCADEPUZZLE.BAR, CHESS_DRAUGHTS.BAR, SCENE_CINEMA_AUDITORIUM.BAR, JAVA.BAR, OBJECTS_DEFAULT_AVATAR.BAR | | NPIA00005 01.00.pkg |
| 0.98 | NPIA00005 | NPBOOT.BAR, DYNFILES.BAR, SHADERS.BAR, JAVA.BAR, SCENE_APARTMENT.BAR, SCENE_CINEMA_AUDITORIUM.BAR, OBJECTS_DEFAULT_AVATAR.BAR, ARCADEBOUNCER.BAR, ARCADESTOCKCAR.BAR, ARCADEEVAC.BAR, ARCADEPUZZLE.BAR | | NPIA00005 00.98.pkg |
| 0.94 | NPEA00013 | NPBOOT.BAR, DYNFILES.BAR, SHADERS.BAR, JAVA.BAR, SCENE_APARTMENT.BAR, SCENE_CINEMA_AUDITORIUM.BAR, OBJECTS_DEFAULT_AVATAR.BAR, ARCADEBOUNCER.BAR, ARCADESTOCKCAR.BAR, ARCADEEVAC.BAR, ARCADEPUZZLE.BAR | | NPEA00013 Beta 00.94.pkg |
| 0.83 | NPIA00005 | NPBOOT.BAR, DYNFILES.BAR, SHADERS.BAR, JAVA.BAR, SCENE_APARTMENT.BAR, SCENE_CINEMA_AUDITORIUM.BAR, OBJECTS.BAR, ARCADEBOUNCER.BAR, ARCADESTOCKCAR.BAR, ARCADEEVAC.BAR, ARCADEPUZZLE.BAR | | NPIA00005 00.83.pkg |
...
**`BAR ARCHIVES WITH SHARC ENCRYPTION :`**
| Version | Title ID | Archives | Cache References |
|----------|-----------|----------|----------|
| 1.82 | NPEA00013 | COREDATA.SHARC, SHADERS.SHARC, SCENE_APARTMENT.SHARC | Soul2 |

**`BAR ARCHIVES WITH NO ENCRYPTION :`**
| Version | Title ID | Archives | Cache References |
|----------|-----------|----------|----------|
| 1.75 | NPEA00013 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR | JrMans2<br>Megalia |
...
| Version | Title ID | Archives | Cache References | PKG References | 
|----------|-----------|----------|----------|----------|
| 1.86 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR |QuantumDoja2<br>Soul4DECH2500|HomeDeveloperBuild186.pkg|
| 1.82 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR |PixelButts|
| 1.80 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR ||HomeDeveloperBuild_180.pkg|
| 1.75 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR ||HomeDeveloperBuild_175.pkg|
| 1.70 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR ||Home.DeveloperBuild_1.70.pkg|
| 1.66 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR ||Home.DeveloperBuild_1.66.pkg|
| 1.65 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, CONFIG_HDK.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR ||Home.DeveloperBuild_BETA_1.65.pkg|
| 1.62 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR ||Home.DeveloperBuild_1.62.pkg|
| 1.60 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, LOCAL_CORE_OBJECTS.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR |Spounts|
| 1.41 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR, SPURIOUS.BAR, DYNFILES.BAR, OBJECTS_DEFAULT_INVENTORY.BAR |Dusty_3|
| 1.35 | NPIA00010 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR, SPURIOUS.BAR, DYNFILES.BAR, OBJECTS_DEFAULT_INVENTORY.BAR ||Home.DeveloperBuild_BETA_1.3.5.pkg| 
| 1.32 | NPEA00013 | COREDATA.BAR, SHADERS.BAR, SCENE_APARTMENT.BAR, DEV_ARCHIVE.BAR, POOL_BOWLING.BAR, SPURIOUS.BAR, DYNFILES.BAR, OBJECTS_DEFAULT_INVENTORY.BAR |SingStar<br>Developer|
...
| Version | Title ID | Archives | Cache References |
|----------|-----------|----------|----------|
| 1.86 | NPIA00005 | COREDATA.SHARC, SHADERS.SHARC, SCENE_APARTMENT.SHARC, CORE_OBJECTS.SHARC | QuantumDoja1 |
| 1.85 | NPIA00005 | COREDATA.SHARC, SHADERS.SHARC, SCENE_APARTMENT.SHARC | Soul3 |
