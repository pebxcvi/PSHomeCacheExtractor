...
SCENE_PATTERNS = [
    ...
    (r'^SCE_GameSpace$',                r'^large\.png$',                                       r'SCE_GameSpace_T001L-SCEA.png'),
    (r'^SCE_GameSpace$',                r'^Jlarge\.png$',                                      r'SCE_GameSpace_T000L-SCEJ.png'),
    (r'^SCE_GameSpace$',                r'^US_GamesSpace_large\.png$',                         r'SCE_GameSpace_T000L-SCEA.png'),
    ...
    (r'^SCE_HomeSquare$',               r'^US_large\.png$',                                    r'SCE_HomeSquare_T006L-SCEA.png'),
    ...
    (r'^SCE_HomeSquare$',               r'^US_HomePlaza_large_T(?P<tval>\d+)\.png$',           r'SCE_HomeSquare_T{tval}L-SCEA.png'),
    (r'^SCE_HomeSquare$',               r'^US_HomePlaza_large\.png$',                          r'SCE_HomeSquare_T000L-SCEA.png'),
    ...
    (r'^SCE_Summerhouse$',              r'^summerhouse_large\.png$',                           r'SCE_Summerhouse_T001L.png'),
